...
int wifi_connect(char *ssid, char *psk)
{
    ...
    //Fil in the connection request parameters
...
void wifi_wait_for_ip_addr(void)
{
    ...
    {
        printk("Error: wifi status requeset failed\r\n");
    }
